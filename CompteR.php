...
<body class="backgroundcompte">
	...
	<?php
		...
		print('
		<form class="form-inline" action="CompteR.php?idvoy='.$_GET["idvoy"].'&id='.$SqlRow['client_id'].'" method="post">
			<p> Connectez-Vous !</p>
    ...
    ');
			...
			($SqlRow= mysqli_fetch_array($SqlResult));
   			...
   			echo '<div class="alert alert-dismissable alert-success">
 				...
 				<strong>Yes !</strong> <p> Vous etes bien logué <meta http-equiv="refresh" URL="reservation.php?idp='.($_GET["idvoy"]).'"> </p>
				</div>
				<a href="reservation.php?id='.($_GET["idvoy"]).'"> RESERVATION </a>';
