				...
				<h3 class="enteteformulaire"> Inscription </h3>
	      		<div class="row">
	      			<div  class="col-xs-6 col-md-4">
		  				...
		  				<br>
		  				<div class="form-group"> 
		    				<input id="login" type="text" class="form-control" name="client_login" placeholder="Identifiant">
		  				</div>
		  				<br>
		  				<br>
		        		<div class="form-group">
	  				...
	  				<div class="col-xs-6 col-md-4">
				     	<p class="positionContact"> Contact : </p>
				  		...
				  		<br>
				  		<div class="form-group">
				    		<input id="Telephone" type="text" class="form-control" name="Telephone" placeholder="Numéro de téléphone">
				  		</div>
				  		<br>
				  		<br>
				  		<div class="form-group">
				  		...
				  		<br>
				  		<div class="form-group">
				    		<input id="Adresse1" type="text" class="form-control" name="Adresse1" placeholder="Adresse ligne 1">
				  		</div>
				  		<br>
				  		<br>
				  		<div class="form-group">
			      	...
			      	<div class="col-xs-6 col-md-4">
			  			...
			  			<br>
			  			<div class="form-group">
			    			<input id="Cp" type="text" class="form-control" name="Cp" placeholder="Code Postal">
			  			</div>
			  			<br>
			  			<br>
	      			</div>
